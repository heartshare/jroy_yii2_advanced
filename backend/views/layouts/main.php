            ...
            <div class="scroll-viewport">
                ...
                <div class="list-group scroll-content">
                    ...
                    <a href="#" class="list-group-item">
                        <div class="media">
                            <div class="pull-left">
                                <img style="width: 48px; height: 48px;" src="static/backend/img/user/01.jpg" alt="Image" class="media-object img-rounded">
                            </div>
                    ...
                    <a href="#" class="list-group-item">
                        <div class="media">
                            <div class="pull-left">
                                <img style="width: 48px; height: 48px;" src="static/backend/img/user/04.jpg" alt="Image" class="media-object img-rounded">
                            </div>
                            <div class="media-body clearfix">
                    ...
                    <a href="#" class="list-group-item">
                        <div class="media">
                            <div class="pull-left">
                                <img style="width: 48px; height: 48px;" src="static/backend/img/user/03.jpg" alt="Image" class="media-object img-rounded">
                            </div>
                            <div class="media-body clearfix">
                    ...
                    <a href="#" class="list-group-item">
                        <div class="media">
                            <div class="pull-left">
                                <img style="width: 48px; height: 48px;" src="static/backend/img/user/05.jpg" alt="Image" class="media-object img-rounded">
                            </div>
                            <div class="media-body clearfix">
                                <small class="pull-right">4h</small>
                                <strong class="media-heading text-primary">
                    ...
                    <a href="#" class="list-group-item">
                        <div class="media">
                            <div class="pull-left">
                                <img style="width: 48px; height: 48px;" src="static/backend/img/user/06.jpg" alt="Image" class="media-object img-rounded">
                            </div>
                            <div class="media-body clearfix">
                                <small class="pull-right">4h</small>
                                <strong class="media-heading text-primary">
...
<li>
    <div data-toggle="collapse-next" class="item user-block has-submenu">
        ...
        <div class="user-block-picture">
            <img src="static/backend/img/user/02.jpg" alt="Avatar" width="60" height="60" class="img-thumbnail img-circle">
